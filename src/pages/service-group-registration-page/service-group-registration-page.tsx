...
import { composeValidators, required, requiredArray, sizeLimit } from 'forms';
...
export const ServiceGroupRegistrationPage = () => {
  ...
  const serviceGroup =
    useWsConnection<Agent>(defaultAdminSocket, `/groups/${serviceGroupId}`) || {};
            ...
            <InstallPluginsStep
              ...
              infoPanel={
                <GeneralAlerts type="INFO">
                  <div>
                    <div>
                      Choose plugins to install on your agents. You will be able to change
                      configuration of any agent separately on Agent Settings page.
                    </div>
                    <span tw="font-bold">Agents to register:&nbsp;</span>
                    {unregisteredAgentsCount}.&nbsp;
                    <span tw="font-bold">Service Group:&nbsp;</span>
                    {serviceGroup.name}.
                  </div>
                </GeneralAlerts>
              }
