...
export const RiskCoverageCell = ({ value = 0, testContext }: Props) => (
  <div className={`inline-flex items-center gap-x-4 font-bold ${value === 100 && 'text-monochrome-dark-tint'}`}>
...
function getCoverageIcon(coverage: number) {
  ...
  if (coverage === 100) {
    return (
      <div tw="flex items-center text-monochrome-medium-tint">
