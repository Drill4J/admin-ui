...
export const TestDetails = ({
  ...
  const { pluginId, buildVersion, agentId, scopeId, tab } =
    useParams<{
      buildVersion?: string;
      pluginId?: string;
      agentId?: string;
  ...
  return (
    <div tw="flex flex-col">
            ...
            <Table
              ...
              columns={[
                ...
                },
                {
                  ...
                  Cell: ({ value }: any) => (
                    <Cells.TestStatus type={value}>{capitalize(value)}</Cells.TestStatus>
                  ),
                  textAlign: 'left',
                  width: '7%',
                },
                ...
                },
                {
                  ...
                  Cell: ({
                    ...
                    <Cells.Clickable data-test="test-actions:view-curl:id" disabled={!value}>
                      <Link
                        to={
                          scopeId
                            ? `/full-page/${agentId}/${buildVersion}/${pluginId}/scope/${scopeId}/${tab}/covered-methods-modal?${queryString.stringify(
                                { coveredMethods: covered, testId: id },
                              )}`
                            : `/full-page/${agentId}/${buildVersion}/${pluginId}/dashboard/${tab}/covered-methods-modal?${queryString.stringify(
                                { coveredMethods: covered, testId: id },
                              )}`
                        }
                      >
      ...
      <Route
        ...
        render={() => (
          <CoveredMethodsByTestSidebar topicCoveredMethodsByTest={topicCoveredMethodsByTest} />
        )}
      />
      <div ref={ref} />
    </div>
