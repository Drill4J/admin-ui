...
export const ActiveBuildCoverageInfo = ({
  ...
  const { percentage: buildCodeCoverage = 0, finishedScopesCount = 0 } = buildCoverage;
  const uniqueCodeCoverage =
    percentFormatter(coveragePercentage) - percentFormatter(overlapPercentage);
  const buildDiff =
  ...
  return (
    <div tw="w-full text-12 leading-16 text-monochrome-default">
      <div className="flex justify-between items-center w-full">
        <div tw="font-bold" data-test="active-build-coverage-info:title">
          BUILD COVERAGE
        </div>
        <Legend
          legendItems={[
      ...
      <div tw="flex items-baseline mt-6 mb-3 text-12" data-test="active-build-coverage-info:status">
        <div
          ...
          data-test="active-build-coverage-info:build-coverage-percentage"
        >
