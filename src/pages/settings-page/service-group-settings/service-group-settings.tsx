...
import { useParams, Switch, Route, Prompt } from 'react-router-dom';
...
export const ServiceGroupSettings = () => {
  ...
  return (
    <div tw="flex flex-col w-full">
      ...
      <div tw="px-6">
        <TabsPanel>
          <Tab name="general" to={`/agents/service-group/${id}/settings/general`}>
            General
          </Tab>
          <Tab name="system" to={`/agents/service-group/${id}/settings/system`}>
            System
          </Tab>
          <Tab name="plugins" to={`/agents/service-group/${id}/settings/plugins`}>
            Plugins
          </Tab>
        </TabsPanel>
      </div>
      <Switch>
        <Route
          ...
          render={() => (
            <ServiceGroupGeneralSettingsForm
      ...
      <UnSaveChangeModal setNextLocation={setNextLocation} path={nextLocation} />
      <Prompt
